import { onRequestGet as __api_link_generate_js_onRequestGet } from "/Users/luxoee/workspace/github/xy_daily/functions/api/link/generate.js"
import { onRequestPost as __api_link_generate_js_onRequestPost } from "/Users/luxoee/workspace/github/xy_daily/functions/api/link/generate.js"
...
import { onRequest as __api_link_generate_js_onRequest } from "/Users/luxoee/workspace/github/xy_daily/functions/api/link/generate.js"
...
export const routes = [
    {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_link_generate_js_onRequestGet],
    },
  {
      routePath: "/api/link/generate",
      mountPath: "/api/link",
      method: "POST",
      middlewares: [],
      modules: [__api_link_generate_js_onRequestPost],
    },
  {
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_link_generate_js_onRequest],
    },
  {
      routePath: "/api/pickup/mail-code",
      mountPath: "/api/pickup",
